					...
					<div class="container">
						<div
							...
							<a href="/"
								...
								style="font-size: 38px"></i>&nbsp;스마트팜
							</a>

							<ul
								class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
								<li><a href="#" class="nav-link text-secondary"
									id="txt-color"> <svg class="bi d-block mx-auto mb-1"
											width="24" height="24" id="icon-size">
                              <use xlink:href="#home" /></svg> Home
								</a></li>
								<li><a href="#" class="nav-link text-white" id="txt-color">
                              ...
                              <use xlink:href="#grid" /></svg> Products
								...
								<li><a href="#" class="nav-link text-white" id="txt-color">
										<svg class="bi d-block mx-auto mb-1" width="24" height="24"
											id="icon-size">
                              <use xlink:href="#people-circle" /></svg> Sign
										in
								</a></li>
							</ul>
						</div>
